              ...
              <div className="card card-registration my-4">
                <div className="row g-0">
                  <div className="col-xl-6 d-none d-xl-block">
                    <img src="https://as2.ftcdn.net/v2/jpg/00/40/86/89/1000_F_40868997_YvVCiLB8Q2KEHlCIaacrmXREiCIh5DrT.jpg"
                  ...
                  <div className="col-xl-6">
                    <Form onSubmit={handleCreate}>
                      <div className="card-body p-md-5 text-black">
                        <h3 className="mb-3 text-uppercase" style={{ color: "#f23bf5", 'fontWeight': 'bolder', 'textAlign': 'center' }}>CHAT WITH US</h3>
